<?php
  ...
  /**
   * В публичном интерфейсе подключаемся под обычным пользователем с минимальным для работы правами
   */
  $db = new \PDO(DB_DSN, NORMAL_USER_LOGIN, NORMAL_USER_PASSWORD);

  /**
   * Простейшая реализация обработки маршрутов,
   * работает только с параметрами GET-запросов
   */
  startDemoSite(
      [
          [
